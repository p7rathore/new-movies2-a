...
const PopularHmovies = () => {
  ...
  useEffect(() => {
    fetch(
      ` https://api.themoviedb.org/3/trending/all/day?api_key=f25a85c11354cad69a2a3d1b9bc9e6b9`
    )
      .then((res) => res.json())
      .then((populardata) => {
  ...
  let crouse3 = document.getElementById("crouse3");

  const preview = () => {
    crouse3.scrollLeft -= 250;
  };
  const next = () => {
    crouse3.scrollLeft += 250;
  };
  ...
  return (
    <>
      <div className="popular-movies">
        <h1 className="popular-movie-text"> tranding movies</h1>
        <div className="movies-po">
          <div className="card" id="crouse3">
